...
BARRAGE_6657_SYNC_TIME = os.getenv("BARRAGE_6657_SYNC_TIME", "04:10").strip() or "04:10"
BARRAGE_6657_STARTUP_SYNC_PAGES = max(1, _get_int_env("BARRAGE_6657_STARTUP_SYNC_PAGES", 5))
